    ...
    <div className="grid grid-cols-[450px_1fr] min-h-screen text-white ">
      <div className="w-full h-screen bg-[#22232b] p-6 top-0 sticky">
        ...
        <div className="mb-[1.6rem]">
          ...
          <button
            className="w-full bg-[#6c738b] text-white border-0 text-base p-3 rounded cursor-pointer transition-colors duration-200  hover:bg-[#46495e]"
      ...
      <div className="bg-[#363844] p-10 grid place-items-center relative overflow-hidden">
        {image ? (
          <>
            <img
              className="w-full h-auto max-w-4xl shadow-[0px 5px 15px rgba(0, 0, 0, 0.15)] relative z-10"
              src={image}
              alt="Working"
            />
            <div
              className="absolute inset-0 z-0 bg-cover bg-center scale-125 filter blur-sm opacity-50"
              style={{
